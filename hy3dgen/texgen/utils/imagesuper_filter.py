...
#  @author      tody
#  @date        2015/08/26
# original code from xinsir
# check out in this link: https://huggingface.co/xinsir/controlnet-tile-sdxl-1.0/blob/main/guided_filter.py
...
def controlnet_img(img):
    controlnet_img = np.array(img)
